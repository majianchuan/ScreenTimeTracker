        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayBoundaryOffsetHours = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ActiveSessionAutoSaveInterval", "AppIconDirectory", "AppInfoStaleThreshold", "DayBoundaryOffsetHours", "IdleDetectionPollingInterval", "IdleThreshold", "IsIdleDetectionEnabled", "MinValidSessionDuration", "SessionMergeTolerance", "SessionOptimizationInterval" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), new TimeSpan(0, 0, 0, 10, 0), "./Data/Icons", new TimeSpan(1, 0, 0, 0, 0), 5, new TimeSpan(0, 0, 0, 10, 0), new TimeSpan(0, 0, 10, 0, 0), false, new TimeSpan(0, 0, 0, 3, 0), new TimeSpan(0, 0, 0, 6, 0), new TimeSpan(0, 1, 0, 0, 0) });
