...
{
    public async ValueTask<GetAppUsageDistributionResponse> Handle(GetAppUsageDistributionQuery request, CancellationToken cancellationToken)
    {
