...
public class GetAppCategoryUsageRankingHandler(
    ...
    ) : IRequestHandler<GetAppCategoryUsageRankingQuery, List<GetAppCategoryUsageRankingResponseItem>>
{
    public async ValueTask<List<GetAppCategoryUsageRankingResponseItem>> Handle(GetAppCategoryUsageRankingQuery request, CancellationToken cancellationToken)
    {
